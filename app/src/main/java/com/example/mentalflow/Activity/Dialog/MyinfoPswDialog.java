...
// 修改昵称对话框
public class MyinfoPswDialog extends AlertDialog implements View.OnClickListener {
    Button mBtnCancel, mBtnUpdate;
    Context mContext;
//    EditText newName;

    public MyinfoPswDialog(Context context, int style) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_myinfo_psw);
