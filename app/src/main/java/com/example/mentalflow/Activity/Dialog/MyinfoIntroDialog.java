...
// 修改简介对话框
public class MyinfoIntroDialog extends AlertDialog implements View.OnClickListener {
    Button mBtnCancel, mBtnUpdate;
    Context mContext;
//    EditText newName;

    public MyinfoIntroDialog(Context context, int style) {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.dialog_myinfo_intro);
